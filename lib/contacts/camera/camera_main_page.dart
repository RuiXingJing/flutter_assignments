...
class CameraMainPage extends StatefulWidget {
  const CameraMainPage({super.key, this.title});

  final String? title;

  @override
  State<StatefulWidget> createState() => _CameraMainPageState();
}
...
class _CameraMainPageState extends State<CameraMainPage> {
  ...
  Future<void> _displayPickImageDialog(
      BuildContext buildContext, OnPickImageCallback onPick) async {
    return showDialog(
        context: context,
